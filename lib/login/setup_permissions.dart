...
class SetupPermissionPage extends StatefulWidget {
  SetupPermissionPage({Key? key, this.email = '', this.name = '', this.userType = 'parent'}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
            ...
            SwitchListTile.adaptive(
              tileColor: cOrtuGrey,
              title: Text('Telepon'),
              subtitle: Text('Kami membutuhkan akses terhadap data panggilan Telepon pada perangkat anak untuk mengawasi panggilan telepon anak terhadap nomor-nomor yang berbahaya'),
