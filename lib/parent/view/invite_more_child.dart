...
class InviteMoreChildPage extends StatefulWidget {
  InviteMoreChildPage({Key? key, required this.title}) : super(key: key);

  final String title;
  @override
  _InviteMoreChildPageState createState() => _InviteMoreChildPageState();

}

class _InviteMoreChildPageState extends State<InviteMoreChildPage> {
  ...
  void onInviteChild() async {
    ...
    Response response = await MediaRepository().inviteChild(emailUser, cChildEmail.text, cPhoneNumber.text,
        cChildName.text, int.parse(cChildAge.text), status, int.parse(cChildOfNumber.text), int.parse(cChildNumber.text));
