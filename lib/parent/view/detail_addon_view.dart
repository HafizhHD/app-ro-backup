...
class DetailAddOnView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: DetailAddOnPage(title: 'Add On HKBP'),
    );
  }

}

class DetailAddOnPage extends StatefulWidget {
  @override
  _DetailAddOnPageState createState() => _DetailAddOnPageState();
  final String title;
  DetailAddOnPage({Key? key, required this.title}) : super(key: key);
}

class _DetailAddOnPageState extends State<DetailAddOnPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
